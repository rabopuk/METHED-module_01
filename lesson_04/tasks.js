{// * Вторая задача
	...
	alert(cap <= firstScore + secondScore + thirdScore ? `Поздравляю, вы поступили на бюджет c результатом суммы баллов за три экзамена: ${firstScore + secondScore + thirdScore}!` : 'Сочувствую, братан(((');

	console.log(cap <= firstScore + secondScore + thirdScore ? `Поздравляю, вы поступили на бюджет c результатом суммы баллов за три экзамена: ${firstScore + secondScore + thirdScore}!` : 'Сочувствую, братан(((');
